(function () {
  ...
  const I18N = {
    en: {
      ...
      'help.audio_cover_strength': 'Controls how strongly Cover/Remix follows the reference audio or injected conditioning during denoising. Higher values make the result adhere more closely to the source structure; lower values leave more room for reinterpretation.',
    ...
    it: {
      ...
      'help.audio_cover_strength': "Controlla quanto Cover/Remix seguono l'audio di riferimento o il conditioning iniettato durante il denoise. Valori più alti fanno aderire maggiormente il risultato alla struttura della sorgente; valori più bassi lasciano più spazio alla reinterpretazione.",
