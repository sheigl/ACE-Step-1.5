#!/usr/bin/env bash
# ACE-Step Gradio Web UI Launcher - Intel XPU (Manual Mode)
...
# This version allows interactive model selection
...
echo "============================================"
echo "   ACE-Step 1.5 - Intel XPU Edition (Manual)"
echo "============================================"
echo
...
echo "Starting ACE-Step Gradio Web UI (Manual Mode)..."
echo "Server will be available at: http://${SERVER_NAME}:${PORT}"
echo
echo "You will be prompted to select models in the UI!"
echo

# Build command with optional parameters - manual mode
ACESTEP_ARGS="acestep --port $PORT --server-name $SERVER_NAME --language $LANGUAGE --manual"
